...
<div class="alert alert-info" role="alert">
    Lūdzu, vēlreiz pārskatiet izsniedzamo zāļu atbilstību receptē izrakstītajam.
    <br> <br>
    Lūdzu, nospiediet pogu “Reģistrēt izsniegšanu”.
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                <a type="submit"  href="/recipes/recipe.php" class="btn btn-outline-primary">Atpakaļ</a>
            </div>

            <div class="col-auto text-end">
                <a type="submit" href="?p=validate" class="btn btn-primary">Reģistrēt izsniegšanu </a>
            </div>
...
<div class="accordion mt-3" id="ako-1">
